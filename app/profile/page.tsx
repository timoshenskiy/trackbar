...
export default function ProfilePage() {
  ...
  const tabs = [
    { name: "All", count: 3, icon: "🎮" },
    { name: "Finished", count: 1, icon: "✓" },
    { name: "Playing", count: 1, icon: "▶" },
    { name: "Dropped", count: 0, icon: "✕" },
    { name: "Want", count: 1, icon: "⭐" },
  ];
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">nezdemkovski</h1>
            <div className="text-gray-400 text-sm">@nezdemkovski</div>
        ...
        {games.map((game, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              {game.metacritic && (
                <div className="text-sm">
                  <div className="text-green-500">{game.metacritic.score}</div>
